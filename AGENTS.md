...
- Local Postman requests use development JWTs generated by `scripts/create-dev-token.ps1`; no token-generation endpoint exists in the API. Production Identity/token issuing is deferred.
